...
namespace OWL_Site.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var userdel = await UserManager.FindByIdAsync(userid);
        ...
        {
            using (var context = new PrincipalContext(ContextType.Domain, MvcApplication.set.AuthDnAddress))
            {
               Debug.WriteLine(context.ValidateCredentials(username, password));
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { Sammaccount = model.Sammaccount, Email = model.Email };
